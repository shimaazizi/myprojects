...
class stopwatch(tk.Frame):
    ...
    def features(self):
        ...
        self.stop_time_button=tk.Button(self,text="STOP",heigh=5,width=7,font=('arial',19,"bold"),background="red",command=self.pause_time)
        ...
        self.quit_button=tk.Button(self,text="QUIT",heigh=5,width=7,font=('arial',19,"bold"),background="blue",command=self.window.quit)
        self.quit_button.pack(side=tk.LEFT)

        self.window.title('MY STOPWATCH')
